...
class Bidang1 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['lapbid'] = $this->M_data->getalapbid1();

        $this->load->view('template/header', $data);
        $this->load->view('template/topbar',);
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/breadcrumb', $data);
        $this->load->view('bidang1/dashboard', $data);
    ...
    public function printe()
    {
        ...
        $this->load->view('bidang1/print', $data);
    }
    ...
    public function formKegiatan()
    {
        ...
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/breadcrumb', $data);
        $this->load->view('bidang1/form_kegiatan', $res, $data);
        $this->load->view('template/footer',);
    }
    ...
    public function lihatKegiatan()
    {
        ...
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/breadcrumb', $data);
        $this->load->view('bidang1/tabelkegiatan', $data);
        $this->load->view('template/footer');
    }
    ...
    public function editKeg()
    {
        ...
        if ($this->db->affected_rows() > 0) {
            ...
            redirect('bidang1/lihatKegiatan');
        } else {
